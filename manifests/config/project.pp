...
define rundeck::config::project(
  ...
  if ($scm_import_config_settings) {
      $scm_import_config = deep_merge($scm_dir, $rundeck::params::scm_import_defaults, $scm_import_config_settings)
  ...
  if ($scm_export_config_settings) {
      $scm_export_config = deep_merge($scm_dir, $rundeck::params::scm_export_defaults, $scm_export_config_settings)
